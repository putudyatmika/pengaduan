...
<div class="d-flex flex-warp divborder divborder-success my-3">
    <div class="flex-fill">
        <h3 class="text-muted">Fasilitas Chatting - Layanan Pengaduan</h3>
    </div>
</div>
...
<div class="d-flex flex-warp divborder divborder-success">
    ...
    @if (Session::has('pesan_berhasil_tersimpan'))
        ...
        <div class="box-footer shadow">
            <a href="{{route('percakapan.tambahpesan')}}" class="btn btn-success"><i class="fa fa-plus"> Tambah Pesan</i></a>
        </div>
    </div>
</div>
@endsection