...
<div class="d-flex flex-warp divborder divborder-success my-3">
    <div class="flex-fill">
        <h3 class="text-muted">Laporan Pengaduan</h3>
    </div>
</div>
...
<div class="divborder divborder-success my-3">
    <div class="shadow bg-white rounded my-3">
        <div>
            <a href="{{route('percakapan.lihatpercakapan')}}" class="btn btn-warning m-1"><i class="fas fa-bullhorn" data-toggle="tooltip" title="Lihat Percakapan"> Lihat Percakapan</i></a>
        </div>
                ...
                <tbody>
                    @foreach($pengaduan as $data)
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-success" href="{{ route('pengaduan.detail.id', $data->id) }}">
                                    <i class="fas fa-location-arrow" data-toggle="tooltip" title="Edit Laporan Pengaduan"></i>
                                </a>
                                &nbsp;
